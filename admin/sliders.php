...
<body>
	...
	<center><h4 style="">Add Sliders</h4></center>
		<div class="container-fluid">
			<div class="row" style="background-color:white; margin:10px 50px; padding:20px;">
				<div class="col-md-3">
				</div>
				<div class="col-md-6">
					<form method="post" action="add_sliders.php"   enctype="multipart/form-data">
			...
			<div class="row" style="background-color:white; margin:10px 50px; padding:20px;">
				<div class="col-md-12">
					<center><h4>Activated Sliders</h4></center>
				</div>
			</div>
			<?php
		...
		try{
			...
			<div class="row" style="background-color:white; margin:10px 50px; padding:20px;">
				<div class="col-md-4">
					<center><img src="<?php echo $row["slider_path"];?>" style="height:150px; width:auto;"></center>
				</div>
				<div class="col-md-4">
				</div>
				<div class="col-md-4">
					...
					<center><button type="submit" name="submit"  style="font-size:40px;background-color:white; margin:20px 0px;" class="btn" >&times;	</button></center>
					</form>
				</div>
