...
<body>
	...
	<section style="position:fixed; left:0px; top:80px;width:20%; height:100%; float:left; margin-top:10px;">
		<div>
		...
		try{
			...
			<div class="row" style="background-color:white; margin:10px 100px;">
				...
				<div class="col-sm-8">
					...
					<button class="btn btn-primary" style="margin:0px 10px; float:left;">FulFilled</button>
