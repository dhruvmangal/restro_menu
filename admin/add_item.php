...
<body>
	...
	<section style="position:fixed; left:0px; top:90px;width:20%; height:100%; float:left; margin-top:10px;">
		<div>
	...
	<section style="width:80%; height:100%; float:right; background-color:#E9EBEE; padding-top:50px; ">
		<div class="container-fluid">
			<form action="add_item_to_db.php" method="post"  enctype="multipart/form-data">
			<div class="row" style="margin:30px 50px; background-color:white; padding:10px;">
				...
				<div class="col-sm-8">
					...
					<br/>					
					<p>Item Price</p>
					<input type="number" name="item_price" class="form-control" placeholder="In Rupees"/>
					<br/>
					<p>Item Discounted Price</p>
					<input type="number" name="item_discount_price" class="form-control" placeholder="In Rupees"/>
					<br/>
