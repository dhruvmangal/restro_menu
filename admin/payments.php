...
<body>
	...
	<section style="width:80%; float:right; height:auto; background-color:#E9EBEE; padding-top:20px; ">
		<div class="container-fluid" style="background-color:white; margin:20px 20px" >
		<div class="row">
			<div class="col-md-1">
				<p>Order_id</p>
			</div>
		...
		$sql="SELECT * FROM orders where fullfill='1' ORDER BY order_id DESC";
		$rows= $conn->query($sql);
		try{
			foreach($rows as $row)
			{
		?>
			...
			<div class="col-md-2">
				<?php echo $row["item_discounted_price"]*$row["item_quantity"]; ?>
			</div>
			<div class="col-md-2">
